...
#     up a furniture store called Lovely Loveseats for Neat Suites on
#     Fleet Street. With our newfound knowledge of Python programming,
...
#     furniture store’s catalog in variables. You will then process the
#     total price and item list of customers, printing them to the
#     output terminal.
...
# Item: "Stylish Settee"
stylish_settee_description = ("Stylish Settee. Faux leather on birch. 29.50 "
...
# Initializing the sales tax value.
sales_tax = .088
...
customer_one_itemization += (customer_one_new_item_text +
...
# Customer One is ready to check out! Calculating the sales tax and
